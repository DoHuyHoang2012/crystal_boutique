                ...
                <div class="row">
                    ...
                    <figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms" data-wow-delay="300ms">
                        <div class="member-thumb">
                            <img style="width: 265px;height: 390px;" src="{{ asset('img/logo_member.jpg') }}" alt="Team Member" class="img-responsive">
                            <figcaption class="overlay">
                                ...
                                <ul class="social-links text-center">
                                    <li><a href=""><i class="fab fa-twitter fa-lg"></i></a></li>
                                    <li><a href="https://www.facebook.com/ngoc.manh.940436"><i class="fab fa-facebook fa-lg"></i></a></li>
                                    <li><a href=""><i class="fab fa-google-plus fa-lg"></i></a></li>
                                </ul>
                            </figcaption>
                        </div>
                    ...
                    <figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms">
                        <div class="member-thumb">
                            ...
                            <figcaption class="overlay">
                                ...
                                <ul class="social-links text-center">
                                    <li><a href=""><i class="fab fa-twitter fa-lg"></i></a></li>
                                    <li><a href="https://www.facebook.com/toilahoang2012"><i class="fab fa-facebook fa-lg"></i></a></li>
                                    <li><a href=""><i class="fab fa-google-plus fa-lg"></i></a></li>
                                </ul>
                            </figcaption>
                        </div>
                    ...
                    <figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms" data-wow-delay="600ms">
                        <div class="member-thumb">
                            ...
                            <figcaption class="overlay">
                                ...
                                <ul class="social-links text-center">
                                    <li><a href=""><i class="fab fa-twitter fa-lg"></i></a></li>
                                    <li><a href="https://www.facebook.com/tuananh.muon.5"><i class="fab fa-facebook fa-lg"></i></a></li>
                                    <li><a href=""><i class="fab fa-google-plus fa-lg"></i></a></li>
                                </ul>
                            </figcaption>
                        </div>
                        <h4>Muộn Văn Tuấn Anh</h4>
                        <span>Thành Viên</span>
                    </figure>
                    <!-- end single member -->
                ...
                <div class="row mb50">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 wow fadeInLeft animated" data-wow-duration="500ms">
                        <div class="contact-address">
                            ...
                            <p><font face="Comic sans MS">https://www.facebook.com/toilahoang2012</font></p>
                            <p><font face="Comic sans MS">crystalboutique2k@gmail.com</font></p>
                            <p><font face="Comic sans MS">55 Giải Phóng, Đồng Tâm, Hai Bà Trưng, Hà Nội</font></p>
                        </div>
                    </div>
                    <!-- end contact address -->
                    ...
                    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12 wow fadeInRight animated" data-wow-duration="500ms" data-wow-delay="600ms">
                        <ul class="footer-social">
                            ...
                            <li><a href="https://www.facebook.com/tuananh.muon.5"><i class="fab fa-twitter fa-2x"></i></a></li>
                            <li><a href="https://www.facebook.com/toilahoang2012"><i class="fab fa-dribbble fa-2x"></i></a></li>
                            <li><a href="https://www.facebook.com/ngoc.manh.940436"><i class="fab fa-facebook fa-2x"></i></a></li>
                        </ul>
                    </div>
